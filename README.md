...
[![Build Status](https://travis-ci.org/atlasrfid/jovix-api.svg?branch=master)](https://travis-ci.org/atlasrfid/jovix-api)
...
6. If you did everything correct, https://atlasrfid.github.io/jovix-api/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://atlasrfid.github.io/jovix-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://atlasrfid.github.io/jovix-api/ with url from the message: `Server started <url>`
